...
local function symbols_filter(entry, ctx)
    ...
    ctx.symbols_filter = type(kind_filter) == "table" and type(kind_filter.default) == "table" and kind_filter.default or
        nil
...
return {
    {
        ...
        keys = {
            ...
            { "<leader>fc",      fzf_open("files", { cwd = vim.fn.stdpath("config") }),      desc = "Find Config File" },
            { "<leader>ff",      fzf_open("files"),                                          desc = "Find Files (Root Dir)" },
            { "<leader>fF",      fzf_open("files", { root = false }),                        desc = "Find Files (cwd)" },
            ...
            { "<leader>sw",      fzf_open("grep_visual"),                                    mode = "v",                       desc = "Selection (Root Dir)" },
            { "<leader>sW",      fzf_open("grep_visual", { root = false }),                  mode = "v",                       desc = "Selection (cwd)" },
            { "<leader>uC",      fzf_open("colorschemes"),                                   desc = "Colorscheme with Preview" },
            {
                "<leader>ss",
                function()
