...
--- URL: https://github.com/LazyVim/LazyVim/blob/main/lua/lazyvim/util/root.lua
...
function M.detectors.lsp(buf)
	...
	clients = vim.tbl_filter(function(client)
		return not vim.tbl_contains(M.root_lsp_ignore or {}, client.name)
...
function M.info()
	...
	lines[#lines + 1] = "```lua"
	lines[#lines + 1] = "root spec = " .. vim.inspect(spec)
	lines[#lines + 1] = "```"
